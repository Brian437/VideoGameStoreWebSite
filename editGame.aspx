<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="editGame.aspx.cs" Inherits="addGame" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="style1">
        ...
        <tr>
            <td width="100">
                Release Date</td>
            <td width="100">
            <asp:DropDownList ID="ddlReleaseMonth" runat="server">
                    ...
                    <asp:DropDownList ID="ddlReleaseDay" runat="server">
                   <asp:ListItem Value="0">-</asp:ListItem>
                    ...
                    <asp:DropDownList ID="ddlReleaseYear" runat="server">  
                        <asp:ListItem></asp:ListItem>
    ...
    <asp:ObjectDataSource ID="odsCategory" runat="server" SelectMethod="GetData" TypeName="CVGS_DAL.CategoryDAL_SQL"></asp:ObjectDataSource>
                ...
                <asp:Button ID="btnReset" runat="server" Text="Reset" UseSubmitBehavior="False" />
            <asp:Button ID="btnCancle" runat="server" OnClick="btnCancle_Click" Text="Cancle" UseSubmitBehavior="False" />
    <br />
</asp:Content>
